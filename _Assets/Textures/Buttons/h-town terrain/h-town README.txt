...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=h-town&box=-82.336275,38.479116,-82.542827,38.317420
...
-----------
  ...
  * h-town Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * h-town Height Map (SRTM3 v4.1).png
  ...
  * h-town Height Map (SRTM30 Plus).png
  ...
  * h-town Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 96m (actual) is equal to 40m in
